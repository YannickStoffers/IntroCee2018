...
class SignupBarbecueAdminView extends ModelView
{
    protected $views = ['update', 'list'];
    protected $template_base_name = 'templates/signup/signup_barbecue_admin';
    ...
    protected function get_form() {
        $form = new SignupFormBarbecue('barbecue', false);
...
$view = new SignupBarbecueAdminView('signup_barbecue_admin', 'Barbecue', get_model('Barbecue'));
$view->run();
